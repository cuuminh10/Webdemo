	...
	<div class="avds">
		<div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
			<div class="avds_small">
				<div class="avds_background" style="background-image:url(${defines.urlPublic}/images/avds_small.jpg)"></div>
				<div class="avds_small_inner">
					<div class="avds_discount_container">
						<img src="${defines.urlPublic}/${defines.urlPublic}/images/discount.png" alt="">
						<div>
			...
			<div class="avds_large">
				<div class="avds_background" style="background-image:url(${defines.urlPublic}/images/avds_large.jpg)"></div>
			...
			<div class="row">
				<div class="col">
					<div class="avds_xl_container clearfix">
						<div class="avds_xl_background" style="background-image:url(${defines.urlPublic}/images/avds_xl.jpg)"></div>
		...
		<div class="container">
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="${defines.urlPublic}/images/icon_1.svg" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="${defines.urlPublic}/images/icon_2.svg" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="${defines.urlPublic}/images/icon_3.svg" alt=""></div>
