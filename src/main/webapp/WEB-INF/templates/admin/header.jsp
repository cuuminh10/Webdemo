...
<html>
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/templates/admin/jquery/jquery-3.2.1.js"></script>
  <script type="text/javascript" src="<%=request.getContextPath() %>/templates/admin/jquery/jquery.validate.js"></script>
  <script type="text/javascript" src="<%=request.getContextPath() %>/templates/admin/jquery/ckeditor/ckeditor.js"></script>		
